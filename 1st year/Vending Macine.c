...
void main()
{
	...
	while (1)
	{
		...
		printf("5. Revive");
		printf("\t\t\tRs. 20.00\n");
		printf("6. Nestle Milo");
		printf("\t\t\tRs. 25.00\n");
		printf("7. Cincau");
		printf("\t\t\tRs. 15.00\n");
		printf("8. Chrysthemum Tea");
		printf("\t\tRs. 15.00\n");
		printf("9. Lipton Ice Lemon Tea");
		printf("\t\tRs. 20.00\n");
		printf("10. Mineral water");
		printf("\t\tRs. 20.00\n");
		printf("11. Cadbury Black Forest");
		printf("\tRs. 50.00\n");
		printf("12. Kitkat");
		printf("\t\t\tRs. 35.00\n");
		printf("13. Crispy");
		...
		printf("15. Mars");
		printf("\t\t\tRs. 20.00\n");
		printf("16. Kinder Bueno");
		printf("\t\tRs. 15.00\n");
		printf("17. White Kinder Bueno");
		printf("\t\tRs. 20.00\n");
		printf("18. Milky Bar");
		printf("\t\t\tRs. 15.00\n");
		printf("19. M&M");
		printf("\t\t\t\tRs. 50.00\n");
		printf("20. Choki Choki");
		printf("\t\t\tRs. 70.00\n");
